...
import spotify.diegodi1.Cancion;
import spotify.diegodi1.DatosInvalidosException;
...
public class Playlist {
	...
	private List<spotify.diegodi1.Cancion> canciones;
	...
	public boolean agregarCancion(spotify.diegodi1.Cancion nueva) throws spotify.diegodi1.DatosInvalidosException {
	...
	public boolean encontrarCancion(String nombreCancion) {
		...
		for (int cont = 0; cont < canciones.size(); cont++) {
			spotify.diegodi1.Cancion cancionExtraida = this.canciones.get(cont);
	...
	public List<spotify.diegodi1.Cancion> getCanciones() {
		return canciones;
	}
